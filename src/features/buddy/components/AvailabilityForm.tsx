        ...
        <div className="bg-white/85 backdrop-blur-md border border-blue-100 rounded-2xl shadow-md shadow-blue-100/30 p-6">
            ...
            <form onSubmit={onAddSubmit} className="flex gap-3 items-end flex-wrap">
                <div className="flex-1 min-w-[140px] flex flex-col gap-1.5">
                    ...
                    <input
                        type="date"
                        className="px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition"
                        value={date}
                ...
                <div className="flex-1 min-w-[120px] flex flex-col gap-1.5">
                    ...
                    <input
                        type="time"
                        className="px-3 py-2 bg-white/70 border border-slate-200 rounded-lg text-sm opacity-60 cursor-not-allowed"
                        value={end}
                        disabled
                    />
                </div>
                <button
                    type="submit"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors cursor-pointer h-[42px]"
                >
