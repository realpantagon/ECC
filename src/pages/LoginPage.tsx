...
const roleBadgeConfig: Record<string, { label: string; cls: string }> = {
    admin: { label: "Admin Portal", cls: "bg-red-50 text-red-600 border-red-100" },
    buddy: { label: "Buddy Portal", cls: "bg-blue-50 text-blue-600 border-blue-100" },
    participant: { label: "Participant Portal", cls: "bg-emerald-50 text-emerald-600 border-emerald-100" },
};
...
export function LoginPage() {
    ...
    const badge = roleBadgeConfig[loginRole];
            ...
            <div className="w-full max-w-sm">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl shadow-xl shadow-slate-200/60 p-8 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col items-center gap-3 text-center">
                        ...
                        {badge && (
                            <span className={`text-xs font-semibold uppercase tracking-wide border rounded-full px-3 py-1 ${badge.cls}`}>
                                {badge.label}
                            </span>
                        )}
                    </div>
